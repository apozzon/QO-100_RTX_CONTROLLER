...
public class Configuration extends JFrame {
	...
	private static String FILE_PATH = "C:/Users/Andrea.DESKTOP-IK5K4JJ/AppData/Roaming/QO-100async/config.json/";
    ...
    public static Config leggiConfig() {
    	...
    	// il file si trova config.json in ...\AppData\Roaming\QO-100async\config.json
    	String userHome = System.getProperty("user.home");
    	FILE_PATH = userHome + "/AppData/Roaming/QO-100async/config.json/";
